...
from api_sequence import SequenceModelAPI
...
class SequencePlayer:
    def __init__(self, config: Config, model, play_config=None):
        ...
        self.api = SequenceModelAPI(self.config, self.model)
    ...
    async def search_my_move(self, env: SequenceEnv, is_root_node=False):
        """
    ...
    @staticmethod
    def counter_key(env: SequenceEnv):
